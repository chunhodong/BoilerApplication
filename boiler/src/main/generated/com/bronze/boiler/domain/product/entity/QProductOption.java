...
public class QProductOption extends EntityPathBase<ProductOption> {
    ...
    private static final long serialVersionUID = 709227256L;
    ...
    public final EnumPath<com.bronze.boiler.domain.product.enums.OptionType> type = createEnum("type", com.bronze.boiler.domain.product.enums.OptionType.class);
